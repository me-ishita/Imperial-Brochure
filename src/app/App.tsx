...
export default function App() {
  ...
  return (
    ...
    >
            ...
            {NAV_ITEMS.map((item) => (
              <button
                ...
                style={{
                  ...
                  color: activeSection === item.id ? "var(--gold)" : "#1e2a3a",
      ...
      <main className="max-w-7xl mx-auto px-6 pb-24" style={{ paddingTop: "6rem" }}>
        ...
        <section id="welcome" className="mb-28 scroll-mt-20">
          ...
          <MetallicCard className="p-8 mb-8" goldAccent>
            ...
            >
              We are a world-leading university for science, technology, engineering, medicine and
              business, where scientific imagination leads to world-changing impact. Founded in 1907
              with a mission to be useful, Imperial has spent more than a century turning discovery
              into practical progress for society.
            </p>
            <p
              style={{
                fontFamily: "Crimson Pro, Georgia, serif",
            ...
            >
              Across our London campuses and international network, Imperial brings together
              exceptional teaching, world-class facilities and collaborative working to unlock
              scientific imagination. The university's story is one of passion, dedication and the
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { stat: "1st in the UK and Europe", label: "Leading university in the region", gold: true },
              ...
              <MetallicCard key={item.stat} className="p-7 text-center" goldAccent={item.gold} steelAccent={!item.gold}>
                ...
                <div style={{ fontSize: "0.8rem", color: "#8a99b3", lineHeight: 1.6, letterSpacing: "0.02em" }}>
                  {item.label}
                </div>
              </MetallicCard>
            ))}
        ...
        <section className="mb-28">
          ...
          <MetallicCard className="p-8 mb-6" goldAccent>
            ...
            >
              Imperial is deliberately focused. Rather than trying to be all things to all students,
              it concentrates on the disciplines that are shaping the future economy and solving the
          ...
          <MetallicCard className="p-8" steelAccent>
            <p style={{ fontSize: "0.95rem", color: "#8a99b3", lineHeight: 1.85 }}>
              That focus creates a distinct culture. Students learn among ambitious peers, with
              research-led teaching, strong technical rigour and close links between discovery,
              enterprise and employability. The result is an education that feels both elite and
              intensely practical.
            </p>
          </MetallicCard>
        </section>
        ...
        <section id="global-standing" className="mb-28 scroll-mt-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            <MetallicCard className="p-7 text-center" goldAccent>
              <div
                className="mb-3"
                style={{ fontFamily: "Playfair Display, serif", fontSize: "2.5rem", fontWeight: 700, color: "var(--gold)", lineHeight: 1.15 }}
              >
                2nd
              </div>
              <div style={{ fontSize: "0.8rem", color: "#8a99b3", lineHeight: 1.6, letterSpacing: "0.02em" }}>
                in the world<br />
                <span style={{ color: "#6a7a8f", fontSize: "0.75rem" }}>QS World University Rankings 2026</span>
              </div>
            </MetallicCard>
            ...
            <MetallicCard className="p-7 text-center" goldAccent>
              ...
              <div style={{ fontSize: "0.8rem", color: "#8a99b3", lineHeight: 1.6, letterSpacing: "0.02em" }}>
                in the world<br />
                <span style={{ color: "#6a7a8f", fontSize: "0.75rem" }}>THE World University Rankings 2026</span>
              </div>
            </MetallicCard>
            ...
            <MetallicCard className="p-7 text-center" steelAccent>
              <div
                className="mb-3"
                style={{ fontFamily: "Playfair Display, serif", fontSize: "2.5rem", fontWeight: 700, color: "#7ab3d0", lineHeight: 1.15 }}
              >
                7th
              </div>
              <div style={{ fontSize: "0.8rem", color: "#8a99b3", lineHeight: 1.6, letterSpacing: "0.02em" }}>
                in the world<br />
                <span style={{ color: "#6a7a8f", fontSize: "0.75rem" }}>QS Sustainability Rankings 2026</span>
              </div>
            </MetallicCard>
          </div>

          <MetallicCard className="p-7">
            <p style={{ fontSize: "0.9rem", color: "#8a99b3", lineHeight: 1.85 }}>
              These rankings reflect more than reputation alone. They point to current excellence in
              teaching, research, sustainability and employer recognition, all of which strengthen
              the value of an Imperial degree internationally.
            </p>
          </MetallicCard>
        </section>
        ...
        <section className="mb-28">
          ...
          <MetallicCard className="p-8 mb-6" goldAccent>
            ...
            >
              ...
              , Imperial has a greater proportion of world-leading 4-star research than any other UK
              university. The same results place Imperial{" "}
              <strong style={{ color: "var(--gold)", fontWeight: 600 }}>
                first in the UK for research outputs and research environment
              </strong>
              , and first for research impact among Russell Group universities.
            </p>
            <p style={{ fontSize: "0.95rem", color: "#8a99b3", lineHeight: 1.85 }}>
              Imperial was also built on a distinguished history of invention, from pioneering
              penicillin, holography and fibre optics to today's frontier work in climate, health,
              AI and advanced engineering. The institution's research culture is designed to solve
              major global challenges at pace and scale.
            </p>
          </MetallicCard>
        </section>
        ...
        <section className="mb-28">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
            <MetallicCard className="lg:col-span-3 p-8" steelAccent>
              ...
              >
                Imperial was named{" "}
                <strong style={{ color: "#7ab3d0", fontWeight: 600 }}>
                  University of the Year for Graduate Employment
                </strong>{" "}
                in The Times and The Sunday Times Good University Guide 2026. Its reputation page
                also highlights consistently strong graduate prospects and worldwide employer
                recognition.
              </p>
              <p style={{ fontSize: "0.95rem", color: "#8a99b3", lineHeight: 1.85 }}>
                Many Imperial courses are designed around analytical, numerical and problem-solving
                strengths, often using project work and real industry scenarios. That gives graduates
                a compelling route into science, technology, finance, consulting, healthcare and
                entrepreneurship.
              </p>
            </MetallicCard>

            <div className="lg:col-span-2 grid grid-cols-1 gap-4">
              {["Science", "Technology", "Finance", "Consulting", "Healthcare", "Entrepreneurship"].map(
                (field) => (
                  <MetallicCard key={field} className="p-4" goldAccent>
                    <div className="flex items-center justify-center">
                      <span style={{ fontSize: "0.85rem", color: "#c5bfb0", fontWeight: 500, letterSpacing: "0.02em" }}>
                        {field}
                      </span>
                    </div>
                  </MetallicCard>
        ...
        <section id="entrepreneurial-core" className="mb-28 scroll-mt-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            <MetallicCard className="p-8" goldAccent>
              <p className="mb-6" style={{ fontSize: "0.95rem", color: "#8a99b3", lineHeight: 1.85 }}>
                Entrepreneurship is embedded in Imperial's identity rather than treated as a side
                activity. The Imperial Enterprise Lab, White City Incubator, Scale Space and related
                hubs help students, staff and alumni turn ideas into ventures, products and services.
              </p>
              <div
              ...
              >
                ...
                <div style={{ fontSize: "0.8rem", color: "#8a99b3", lineHeight: 1.5 }}>
                  Large university for startup creation<br />
                  <span style={{ color: "#6a7a8f", fontSize: "0.75rem" }}>Redstone University Startup Index 2024</span>
                </div>
              </div>
            </MetallicCard>
            ...
            <MetallicCard className="p-8" steelAccent>
              <h3
                className="mb-4"
                style={{ fontFamily: "Playfair Display, serif", fontSize: "1.1rem", color: "#7ab3d0", fontWeight: 600 }}
              >
                Innovation Hubs
              </h3>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={hub} className="flex items-start gap-3">
                    ...
                    <p style={{ fontSize: "0.9rem", color: "#c5bfb0", lineHeight: 1.75 }}>{hub}</p>
                  </li>
                ))}
              </ul>
              <p
                className="mt-5"
                style={{ fontSize: "0.85rem", color: "#8a99b3", lineHeight: 1.75, fontStyle: "italic" }}
              >
        ...
        <section className="mb-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <MetallicCard className="p-8" goldAccent>
              <h3
                className="mb-3"
                style={{ fontFamily: "Playfair Display, serif", fontSize: "1.15rem", color: "var(--gold)", fontWeight: 600 }}
              >
                South Kensington — Albertopolis
              </h3>
              <p style={{ fontSize: "0.9rem", color: "#8a99b3", lineHeight: 1.85 }}>
                South Kensington sits in{" "}
                <strong style={{ color: "#e8e4d9" }}>Albertopolis, the world's first innovation district</strong>. This
                historic campus provides a prestigious setting rich in scientific heritage and cultural institutions.
              </p>
            </MetallicCard>
            ...
            <MetallicCard className="p-8" steelAccent>
              <h3
                className="mb-3"
                style={{ fontFamily: "Playfair Display, serif", fontSize: "1.15rem", color: "#7ab3d0", fontWeight: 600 }}
              >
                White City — Modern Innovation Campus
              </h3>
              <p style={{ fontSize: "0.9rem", color: "#8a99b3", lineHeight: 1.85 }}>
                White City is a modern innovation campus built for collaboration, incubation and
                commercialisation. It includes laboratories, incubator space, prototyping facilities
                and collaboration areas that connect researchers, startups, corporates and investors.
              </p>
            </MetallicCard>
          </div>

          <MetallicCard className="p-7 mt-6">
            <p style={{ fontSize: "0.9rem", color: "#8a99b3", lineHeight: 1.85, textAlign: "center" }}>
        ...
        <section id="our-community" className="mb-28 scroll-mt-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <MetallicCard className="p-8" steelAccent>
              <div
                className="mb-4"
                style={{ fontFamily: "Playfair Display, serif", fontSize: "2rem", fontWeight: 700, color: "#7ab3d0", lineHeight: 1.15 }}
              >
                200+
              </div>
              <p style={{ fontSize: "0.9rem", color: "#8a99b3", lineHeight: 1.85 }}>
            ...
            <MetallicCard className="p-8" goldAccent>
              <div
                className="mb-4"
                style={{ fontFamily: "Playfair Display, serif", fontSize: "2rem", fontWeight: 700, color: "var(--gold)", lineHeight: 1.15 }}
              >
                £10M+
              </div>
              <p style={{ fontSize: "0.9rem", color: "#8a99b3", lineHeight: 1.85 }}>
                Imperial Bursary support for home students in 2024/25, reflecting a commitment to
                widening access and supporting talent
              </p>
            </MetallicCard>

            {/* NEW: Research Income stat */}
            <MetallicCard className="p-8" steelAccent>
              <div
                className="mb-4"
                style={{ fontFamily: "Playfair Display, serif", fontSize: "2rem", fontWeight: 700, color: "#7ab3d0", lineHeight: 1.15 }}
              ...
              <p style={{ fontSize: "0.9rem", color: "#8a99b3", lineHeight: 1.85 }}>
                Research Income in the 2024/25 Academic Year, underscoring Imperial's position as a
              ...
              <MetallicCard key={item.title} className="p-6" goldAccent={i % 3 === 0} steelAccent={i % 3 !== 0}>
                <h3
                  ...
                  style={{
                    fontFamily: "Playfair Display, serif",
                    fontSize: "1.05rem",
                    color: i % 3 === 0 ? "var(--gold)" : "#7ab3d0",
                    fontWeight: 600,
                  }}
                >
                  {item.title}
                </h3>
                <p style={{ fontSize: "0.88rem", color: "#8a99b3", lineHeight: 1.75 }}>{item.desc}</p>
              </MetallicCard>
            ))}
          </div>
        </section>
        ...
        <section className="mb-28">
          ...
          <MetallicCard className="p-10" goldAccent>
            ...
            >
              Imperial is not simply a prestigious London university. It is a{" "}
              <strong style={{ color: "var(--gold)", fontWeight: 600 }}>
                specialist, globally ranked institution
              </strong>{" "}
              where rigorous academic excellence meets frontier research, entrepreneurial execution
            ...
            >
              For students comparing Imperial with other top universities, the distinction is clear:
              Imperial combines elite scientific reputation with a culture of impact, built for
              people who want not only to study the future, but to{" "}
              <strong style={{ color: "var(--gold)", fontWeight: 600 }}>shape it</strong>.
            </p>
          </MetallicCard>
        </section>
        ...
        <section id="objectives" className="mb-28 scroll-mt-20">
          ...
          <p className="mb-10" style={{ fontSize: "0.9rem", color: "#4a5a6e", maxWidth: "620px", lineHeight: 1.75 }}>
            The partnership is designed around three strategic pillars that align Imperial's research
            and talent with financial institutions' business priorities and sustainability agendas.
          </p>
              ...
              <MetallicCard key={pillar.num} className="p-7" goldAccent={pillar.gold} steelAccent={!pillar.gold}>
                <div
                  ...
                  style={{
                    ...
                    fontWeight: 700,
                    lineHeight: 1,
                    color: pillar.gold ? "rgba(201,169,110,0.18)" : "rgba(74,127,165,0.18)",
                ...
                <p style={{ fontSize: "0.85rem", color: "#8a99b3", lineHeight: 1.8 }}>{pillar.body}</p>
              </MetallicCard>
            ))}
          </div>
        </section>
        ...
        <section id="imperial-brings" className="mb-28 scroll-mt-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <MetallicCard className="p-8" goldAccent>
              <h3
                className="mb-2"
                style={{ fontFamily: "Playfair Display, serif", fontSize: "1.2rem", color: "var(--gold)", fontWeight: 600 }}
              >
                Academic Excellence &amp; Global Reputation
              </h3>
              <p className="mb-4" style={{ fontSize: "0.85rem", color: "#8a99b3", lineHeight: 1.8 }}>
                Imperial College London is Europe's top university and #2 globally, with leading
                positions in finance, data science and AI. Its track record of Nobel Prizes, Fields
                Medals and Fellows of the Royal Society highlights deep quantitative and scientific
                strength.
              </p>
              <p className="mb-3" style={{ fontSize: "0.8rem", color: "#6a7a8f", lineHeight: 1.7 }}>
                Imperial's Business School and Faculty of Engineering lead in:
              </p>
              <ul className="space-y-1.5">
                {[
                  ...
                  <li key={item} className="flex items-start gap-2" style={{ fontSize: "0.82rem", color: "#c5bfb0" }}>
            ...
            <MetallicCard className="p-8" steelAccent>
              <h3
                className="mb-2"
                style={{ fontFamily: "Playfair Display, serif", fontSize: "1.2rem", color: "#7ab3d0", fontWeight: 600 }}
              >
                Climate &amp; Sustainability Leadership
              </h3>
              <p className="mb-4" style={{ fontSize: "0.85rem", color: "#8a99b3", lineHeight: 1.8 }}>
                Through the Grantham Institute and new Schools of Convergence Science, Imperial sits
                at the frontier of climate science, energy systems and sustainable finance.
                Partnerships with financial institutions have enabled cleantech accelerators and
                climate innovation centres, backing{" "}
                <strong style={{ color: "#e8e4d9" }}>100+ climate‑focused ventures</strong>.
              </p>
              <p className="mb-3" style={{ fontSize: "0.8rem", color: "#6a7a8f", lineHeight: 1.7 }}>
                Key capabilities for financial services partners:
              </p>
              <ul className="space-y-1.5">
                {[
                  ...
                  <li key={item} className="flex items-start gap-2" style={{ fontSize: "0.82rem", color: "#c5bfb0" }}>
                    <span style={{ color: "#7ab3d0", marginTop: "0.35rem", fontSize: "0.45rem", flexShrink: 0 }}>◆</span>
                    {item}
                  </li>
                ))}
              </ul>
            ...
            <MetallicCard className="lg:col-span-2 p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <p style={{ fontSize: "0.85rem", color: "#8a99b3", lineHeight: 1.8 }}>
                    Imperial's FinTech Lab, Data Science Institute and Mathematics of Finance Group
                    work on blockchain and DeFi, digital assets, RegTech, AI/ML for trading and
                    risk, and quantum computing for optimisation. These clusters generate impactful
                    research, fintech spin‑outs and practical collaborations with financial
                    institutions.
                  </p>
                </div>
                <div>
        ...
        <section id="flagship" className="mb-28 scroll-mt-20">
          ...
          <p className="mb-10" style={{ fontSize: "0.9rem", color: "#4a5a6e", maxWidth: "620px", lineHeight: 1.75 }}>
            A modular portfolio of initiatives allows the partnership to be tuned to strategic
            priorities and target geographies. The final mix can be tuned to each partner's
            priorities across wealth, markets, retail and wholesale, and across regions such as the
            UK, Asia and MENA.
          </p>
          ...
          <MetallicCard className="overflow-hidden" goldAccent>
            <div className="grid" style={{ gridTemplateColumns: "1fr 2fr" }}>
              <div
                className="px-6 py-4"
                style={{ borderBottom: "1px solid rgba(201,169,110,0.15)", background: "rgba(201,169,110,0.06)" }}
              >
                <span style={{ fontSize: "0.65rem", letterSpacing: "0.15em", textTransform: "uppercase", color: "var(--gold)", fontFamily: "Inter, sans-serif" }}>
                  Pillar
                </span>
              </div>
              <div
                className="px-6 py-4"
                style={{ borderBottom: "1px solid rgba(201,169,110,0.15)", background: "rgba(201,169,110,0.06)", borderLeft: "1px solid rgba(201,169,110,0.12)" }}
              >
                <span style={{ fontSize: "0.65rem", letterSpacing: "0.15em", textTransform: "uppercase", color: "var(--gold)", fontFamily: "Inter, sans-serif" }}>
              ...
              {[
                ...
                <div key={row.pillar} className="contents">
                  <div
                    className="px-6 py-5"
                    style={{
                      borderBottom: i < 5 ? "1px solid rgba(201,169,110,0.08)" : "none",
                      background: i % 2 === 0 ? "transparent" : "rgba(201,169,110,0.02)",
                    }}
                  >
                    <span style={{ fontSize: "0.85rem", fontWeight: 500, color: "#e8e4d9" }}>{row.pillar}</span>
                  </div>
                  <div
                    className="px-6 py-5"
                    style={{
                  ...
                  >
                    <span style={{ fontSize: "0.85rem", color: "#8a99b3", lineHeight: 1.7 }}>{row.initiative}</span>
                  </div>
                </div>
              ))}
            </div>
        ...
        <section id="climate" className="mb-28 scroll-mt-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <MetallicCard className="p-8" steelAccent>
              <p style={{ fontSize: "0.9rem", color: "#8a99b3", lineHeight: 1.85 }}>
                Philanthropic funding and strategic partnerships from financial institutions have
                enabled Imperial to launch cleantech innovation programmes that support UK startups
                with grants, workspace, mentoring and commercialisation support, targeting
                technologies with measurable climate impact.
              </p>
              <div
                className="mt-6 p-5 rounded-xl"
                style={{ background: "rgba(74,127,165,0.06)", border: "1px solid rgba(74,127,165,0.15)" }}
              >
                <div className="flex items-center gap-3">
                  <div style={{ fontFamily: "Playfair Display, serif", fontSize: "2.5rem", fontWeight: 700, color: "#7ab3d0", lineHeight: 1 }}>
                    100+
                  </div>
                  <div style={{ fontSize: "0.8rem", color: "#6a7a8f", lineHeight: 1.5 }}>
                    climate‑focused ventures<br />backed to date
                  </div>
                </div>
              </div>
            </MetallicCard>
            ...
            <MetallicCard className="p-8" goldAccent>
              <h3
                className="mb-4"
                style={{ fontFamily: "Playfair Display, serif", fontSize: "1.05rem", color: "var(--gold)", fontWeight: 600 }}
              >
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={item} className="flex items-start gap-3">
                    ...
                    <p style={{ fontSize: "0.85rem", color: "#c5bfb0", lineHeight: 1.75 }}>{item}</p>
                  </li>
                ))}
              </ul>
            </MetallicCard>
        ...
        <section id="governance" className="mb-28 scroll-mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            {[
              ...
              <MetallicCard key={item.title} className="p-7" goldAccent={item.gold} steelAccent={!item.gold}>
                <h3
                  className="mb-3"
                  style={{ fontFamily: "Playfair Display, serif", fontSize: "1.05rem", color: item.gold ? "var(--gold)" : "#7ab3d0", fontWeight: 600 }}
                >
                  {item.title}
                </h3>
                <p style={{ fontSize: "0.85rem", color: "#8a99b3", lineHeight: 1.8 }}>{item.body}</p>
              </MetallicCard>
            ))}
          </div>
          ...
          <MetallicCard className="p-7">
            <h3
              className="mb-4"
              style={{ fontFamily: "Playfair Display, serif", fontSize: "1rem", color: "var(--gold)", fontWeight: 600 }}
            >
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
              {["Ventures supported", "Employees trained", "Joint publications", "Pilots launched", "Capital mobilised"].map((metric) => (
                ...
                >
                  <span style={{ fontSize: "0.75rem", color: "#c5bfb0", lineHeight: 1.5, display: "block" }}>{metric}</span>
                </div>
              ))}
            </div>
          </MetallicCard>
        ...
        <section id="roadmap" className="mb-16 scroll-mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                phase: "Phase 1", period: "0–3 months", label: "Design",
                items: [
              ...
              {
                phase: "Phase 2", period: "3–12 months", label: "Launch",
                items: [
              ...
              {
                phase: "Phase 3", period: "Year 2–3", label: "Scale",
                items: [
              ...
              <MetallicCard key={phase.phase} className="p-7 relative overflow-visible" goldAccent={phase.gold} steelAccent={!phase.gold}>
                {i < 2 && (
                  <div
                    ...
                    style={{ background: "linear-gradient(90deg, rgba(201,169,110,0.4), rgba(201,169,110,0.1))" }}
                  />
                )}
                <div className="flex items-start gap-3 mb-5">
                  <div
                    ...
                    style={{
                      background: phase.gold ? "rgba(201,169,110,0.12)" : "rgba(74,127,165,0.12)",
                      border: phase.gold ? "1px solid rgba(201,169,110,0.3)" : "1px solid rgba(74,127,165,0.3)",
                    }}
                  >
                    <span style={{ fontSize: "0.7rem", fontWeight: 700, color: phase.gold ? "var(--gold)" : "#7ab3d0" }}>
                      {i + 1}
                    </span>
                  </div>
                  <div>
                    <div style={{ fontSize: "0.65rem", letterSpacing: "0.12em", textTransform: "uppercase", color: phase.gold ? "var(--gold)" : "#7ab3d0", fontFamily: "Inter, sans-serif" }}>
                      {phase.phase} — {phase.label}
                    </div>
                    <div style={{ fontSize: "0.75rem", color: "#6a7a8f" }}>{phase.period}</div>
                  </div>
                </div>
                <ul className="space-y-3">
                  {phase.items.map((item) => (
                    <li key={item} className="flex items-start gap-2.5">
                      ...
                      <p style={{ fontSize: "0.83rem", color: "#8a99b3", lineHeight: 1.75 }}>{item}</p>
                    </li>
                  ))}
                </ul>
              </MetallicCard>
      ...
      <footer
        className="relative"
        style={{ borderTop: "1px solid rgba(201,169,110,0.15)", background: "rgba(201,169,110,0.02)" }}
      >
